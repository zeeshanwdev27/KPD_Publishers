...
function BookPublishing() {
  return (
    <>
    <HeroSection title={"eBook Publishing Has Never Been Easier. Get Professional Digital Publishing Services"} description={"In today’s expanding digital reading world, eBooks have become one of the most effective ways to reach a global audience. At KDP Publications, we simplify the publishing journey and transform your manuscript into a professionally formatted and market-ready digital book. Whether you are a first-time author or an established writer, we make the process seamless, guided, and stress-free."}/>
    <AboutPublishing/>
